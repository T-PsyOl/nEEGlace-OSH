/**
Audio onset detection using the energy of the signal
-----------------------------------------------------
...
the energy threshold, it activates the digital pin if it is not in the refractory period 
*/
...
float activationDuration = 0.1;				// duration to activate the digital output pin after onset detection (sec)
float inputGain = 30;							// input gain for the microphones 	
float energyThreshold = 0.5;					// threshold for detecting an onset
