...
- **Bela Mini** for real-time audio and control
- **OpenBCI Cyton (8-channel) or Cyton + Daisy (16-channel)** for (ear)-EEG
- **Roland CS-10EM binaural microphones** for stereo audio
